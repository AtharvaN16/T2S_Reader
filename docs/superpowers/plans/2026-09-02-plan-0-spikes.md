...
- Every spike ends in a findings file at `spikes/findings/<YYYY-MM-DD>-<name>.md` using the template in Task 1, and in a one-line RESOLVED note added to the matching spec §7 subsection.
...
- Create: `spikes/findings/TEMPLATE.md`
- Create: `.gitignore`
...
```bash
git add spikes spikes/findings/TEMPLATE.md .gitignore
...
- Create: `spikes/findings/2026-09-XX-background-audio-compute.md`
...
- Create: `spikes/findings/2026-09-XX-bgprocessing-compute.md`
...
- Create: `spikes/findings/2026-09-XX-runtime-benchmark.md`
...
**Files:**
- Create: `spikes/findings/2026-09-XX-word-timings.md`
...
- Create: `spikes/findings/2026-09-XX-g2p-coverage.md`
