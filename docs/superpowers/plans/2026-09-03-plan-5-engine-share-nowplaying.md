...
- **Kokoro is gated** (spec §7.1–§7.5, §7.7). Do not add its package, weights, or shipping code until each required Plan 0 finding exists and is accepted. Task 5 below is complete as a plan but deliberately blocked for implementation today.
