#!/usr/bin/env bash
# Downloads Inter 4.1 and copies the six static faces the app bundles (spec §2.4.1) plus the OFL
...
for face in Inter-Regular Inter-Medium Inter-SemiBold Inter-Bold InterDisplay-ExtraBold InterDisplay-Black; do
